...
CREATE MEMORY TABLE WAREHOUSE.products (
...
INSERT INTO WAREHOUSE.products (NAME, CATEGORY, AMOUNT, UNIT, PURCHASEPRICE, SELLPRICE, DESCRIPTION)
...
GRANT SELECT ON  WAREHOUSE.PRODUCTS TO DEV;
